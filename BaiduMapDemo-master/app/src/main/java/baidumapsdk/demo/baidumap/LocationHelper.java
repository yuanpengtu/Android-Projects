...
public class LocationHelper {
    ...
    public LocationHelper(Application application) {
        synchronized (objLock) {
            if (client == null) {
                client = new LocationClient(application);
    ...
    public LocationClientOption getDefaultLocationClientOption() {
        if (mOption == null) {
            ...
            mOption.setCoorType(BaiduUtils.CoorType_BD09LL);//可选，默认gcj02，设置返回的定位结果坐标系，如果配合百度地图使用，建议设置为bd09ll;
